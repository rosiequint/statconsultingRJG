...
ggplot(new_score, aes(x = beating_justified_score, y = pred_p,
  ...
  scale_x_continuous(breaks = 0:5) +
  labs(
    x = "domestic violence justification score (0–5)",
    y = "Predicted probability of any domestic violence",
