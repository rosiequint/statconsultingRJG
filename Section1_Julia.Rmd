...
**seems like some variables such as d105g have all NAs to begin with, so should remove those variables from analysis ?**
...
dhs_surv <- dhs_surv %>%
  # remove if any of the following are NA
  filter(!(is.na(d105a) | is.na(d105b) | is.na(d105c) | is.na(d105d) | is.na(d105e) | is.na(d105f) | 
           is.na(d105g) | is.na(d105h) | is.na(d105i) | is.na(d105j) | is.na(d105k) |
           is.na(d105l) | is.na(d105m) | is.na(d105n) | is.na(d106) | is.na(d107) |
           is.na(d108)))
...
dhs_surv$variables$d105a

dhs_surv <- dhs_surv %>% 
  mutate(any_domestic_violence = case_when(
  d105a > 0 | d105b > 0 | d105c > 0 | d105d > 0 | d105e > 0 | d105f > 0 | 
    d105g > 0 | d105h > 0 | d105i > 0 | d105j > 0 | d105k > 0 |
    d105l > 0 | d105m > 0 | d105n > 0 | d106 > 0 | d107 > 0 |
    d108 > 0 ~ 1,
  d105a == 0 & d105b == 0 & d105c == 0 & d105d == 0 & d105e == 0 & d105f == 0 &   d105g == 0 & d105h == 0 & d105i == 0 & d105j == 0 & d105k == 0 &
  d105l == 0 & d105m == 0 & d105n == 0 & d106 == 0 & d107 == 0 & d108 == 0 ~ 0
  #TRUE ~ NA_real_
))
```
...
dhs_surv %>%
  summarise(prop_dv = survey_prop(any_domestic_violence, na.rm = TRUE)) %>%
  mutate(prop_dv = prop_dv * 100) %>%
  round(digits = 2)
dhs_surv$variables$any_domestic_violence
```
