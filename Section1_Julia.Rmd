...
We may want to predict the probability of DV based on number of co-wives or beating justification score. To do so, we can set our other control variables (education, wealth, residence) to “typical” values (most common levels). 
